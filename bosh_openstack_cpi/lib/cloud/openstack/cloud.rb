  ...
  class Cloud < Bosh::Cloud
    ...
    def create_vm(agent_id, stemcell_id, resource_pool,
      ...
      with_thread_name("create_vm(#{agent_id}, ...)") do
        ...
        server_userdata = Yajl::Encoder.encode(user_data(server_name, network_spec, keypair.public_key))
        ...
        server_params = {
          ...
          :nics => nics,
          :user_data => server_userdata,
          :personality => [ {:path => "#{BOSH_APP_DIR}/user_data.json", :contents => server_userdata} ]
        }
